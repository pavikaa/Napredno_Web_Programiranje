                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('projects.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="completed_tasks" class="form-control @error('completed_tasks') is-invalid @enderror" name="completed_tasks" required autocomplete="completed_tasks">{{ old('description') }}</textarea>
